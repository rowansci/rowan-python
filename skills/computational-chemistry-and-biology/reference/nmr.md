...
NMR prediction is in private beta. Results may change as scaling factors are finalized and the implementation is improved.
...
- `solvent` (default `"chloroform"`): solvent for the prediction; introspect `rowan.Solvent` for the available solvents.
