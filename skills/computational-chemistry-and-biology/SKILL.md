...
- **Binding affinity**: score protein–ligand affinity with SQM, GNINA, AEV-PLIG, or NESSO; NESSO also accepts protein sequences and ligand SMILES without a PDB. See [reference/binding_affinity.md](reference/binding_affinity.md).
