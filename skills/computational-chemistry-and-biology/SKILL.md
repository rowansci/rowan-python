...
- **Docking**: dock a ligand into a protein site and return the pose, refined with an NNP strain-energy correction, plus optional conformer search and geometry optimization, for accurate single-ligand pose prediction. See [reference/docking.md](reference/docking.md).
