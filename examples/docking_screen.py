...
ligands = ["CCC(C)(C)NC1=NCC2(CCC(=O)C2C)N1",
...
for ligand in ligands:
    workflow = rowan.submit_docking_workflow(protein.uuid,
...
for workflow in workflows:
    ...
    for conformer in conformers:
        energy = rowan.retrieve_calculation_molecules(conformer[0] if isinstance(conformer, list)
                                                      else conformer)[0]['energy']
