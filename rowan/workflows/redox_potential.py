...
def submit_redox_potential_workflow(
    ...
    Args:
        initial_molecule: molecule to calculate the redox potential of
        reduction: whether to calculate the reduction potential
        oxidation: whether to calculate the oxidation potential
